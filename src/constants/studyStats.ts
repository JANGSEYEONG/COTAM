import { playerList } from '@/app/people/constants';
...
export const STUDY_MEMBERS_COUNT = playerList.length; // 스터디원 수
export const ONLINE_STUDY_SESSIONS_COMPLETED = 47; // 온라인 스터디 횟수
